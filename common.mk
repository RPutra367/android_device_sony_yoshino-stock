...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/display/qdcm_calib_data_3.xml:$(TARGET_COPY_OUT_VENDOR)/etc/qdcm_calib_data_3.xml \
    $(LOCAL_PATH)/display/qdcm_calib_data_6.xml:$(TARGET_COPY_OUT_VENDOR)/etc/qdcm_calib_data_6.xml
